...
echo "Setting up SSL with self-signed certificate for crypto.viguri.org..."
...
# Create an updated Apache configuration file with HTTPS support
...
curl -k https://crypto.viguri.org/api/test || echo "Failed to connect to API endpoint"
