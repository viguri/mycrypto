class WalletManager {
    ...
    startAutoRefresh() {
        ...
        this.refreshInterval = setInterval(() => this.loadWallets(), 30000);
    }
    ...
    async viewWalletDetails(address) {
        try {
            ...
            if (!walletResp.ok || !txResp.ok) {
                const errorData = !walletResp.ok ? walletResponse : txResponse;
            ...
            this.displayWalletDetails(walletData, txData);
            this.openModal();
        } catch (error) {
